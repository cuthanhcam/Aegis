namespace Aegis.UnitTests.Application.Features.Query
{
    ...
    {
        [Fact]
        public void ExecuteAsync_MergesPersistedAndContextualTuples()
        {
        ...
        [Fact]
        public void ExecuteAsync_AppliesDenyPrecedence()
        {
        ...
        [Fact]
        public void ExecuteAsync_DeduplicatesTuples()
        {
        ...
        [Fact]
        public void ExecuteAsync_HandlesCaseSensitivity()
        {
        ...
        [Fact]
        public void ExecuteAsync_FiltersContextualTuplesCorrectly()
        {
        ...
        [Fact]
        public void ExecuteAsync_ReturnsEmptyWhenNoTuplesMatch()
        {
